...
2. "¿Qué hace `profile-detection.md`?" — pregunta técnica específica; leer y responder directo.
3. "Hola" — saludo; responder con los pendientes relevantes (capa de prioridad, no volcado) según `communication.md`.
