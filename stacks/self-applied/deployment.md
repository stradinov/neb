...
Cuarto tipo de validación, complementa los 3 de [`process/delivery.md`](../../process/delivery.md) "Validación". Aplica a cualquier cambio en stack `self-applied`.

### Por qué diferida

Los walkthroughs mentales en Fase 5 detectan ambigüedad del diseño, no fricción real. La fricción aparece cuando el lineamiento se aplica en una sesión de trabajo en otro stack (cualquier stack de software o documentación). Solo el uso revela si el cambio ayuda, estorba o requiere ajuste.
...
- **Aplicado en ≥ 10 sesiones de trabajo en otros stacks sin reporte negativo del dev**.
...
```
[ ] [<slug>-validacion-uso] <req> — validación diferida en uso (push <fecha>). Cierre tras ≥ 10 sesiones de trabajo en otros stacks sin reporte negativo. Change MD: <path>.
```
