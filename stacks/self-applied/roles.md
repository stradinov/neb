...
- **Vocabulario canónico agnóstico del stack**: estados, fases y artefactos no asumen un stack ni tipo de proyecto particular. Verificar contra los 3 tipos de validación de [delivery.md](../../process/delivery.md) y el principio "agnóstica del stack en su core" de [principles.md](../../methodology/principles.md).
