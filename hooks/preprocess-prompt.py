...
def build_preamble(mode, original, corrected):
    ...
    if mode == "full":
        return (
            ...
            "2. Espera confirmación explícita (\"sí\", \"ok\", \"continue\", \"go\", etc. según idioma) antes "
            "de tomar acciones que modifiquen archivos, ejecuten comandos, o llamen tools de escritura.\n"
