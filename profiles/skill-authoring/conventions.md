...
Ejemplo (skill filtrado de un profile de un framework):
...
## Asociación con profiles

Cada skill debe registrarse en dos lugares:

1. `skills/README.md` — inventario maestro (ver `methodology/skills.md`).
2. `profiles/<profile>/skills.md` del profile donde aplica — tabla de cuándo cargarlo dentro del workflow del profile.

Un skill puede asociarse a múltiples profiles si el dominio cruza proyectos de tipos distintos.
