...
**Síntomas:** Un skill específico de un profile carga cuando se trabaja en otro proyecto fuera de su scope.

**Solución:**
1. Revisar el frontmatter `description`.
2. Agregar negación explícita: `NO usar para <proyecto> (<tecnología>)`.
3. Ser específico sobre el profile cubierto: indicar versión del framework, rutas de repos.
