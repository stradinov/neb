...
Si el REQ también toca la metodología general (lineamientos, profiles, etc.), el profile activo es `skill-authoring` para los artefactos del skill y `self-applied` para el resto. Si hay ambigüedad, anunciar y preguntar.
