...
- **Versionado SemVer**:
  ...
  - Minor (1.0.x → 1.1.0): nuevos lineamientos, stacks, hooks.
...
Correr primero para scaffold inicial: `bash bootstrap/init-stack-subproject.sh <nombre> [--overlay-base self-applied|none]`

El script crea `stacks/<nombre>/` con los 6 archivos mínimos desde templates e imprime la checklist de acoples pendientes. Ver teoría (cuándo crear, tipos, nombramiento) en [`methodology/stacks.md`](methodology/stacks.md) y convenciones de contenido en [`stacks/stack-authoring/conventions.md`](stacks/stack-authoring/conventions.md).

Acoples de roles (todo stack nuevo):
- Definir rol principal en `stacks/<nombre>/roles.md`; decidir herencia de revisores (overlay) o propios.
- Si define revisores propios como subagentes: seguir "Agregar un subagente" abajo.
- Agregar fila en `process/roles-invocation.md` tabla "Default por stack" + matriz "Cobertura mínima por fase".
